...
export function CreateActivityModal({ closeCreateAtivityModal }: CreateActivityModalProps) {
          ...
          <div className='space-y-2'>
              <div className='flex items-center justify-between'>
                ...
                <button  className='text-zinc-400'>
                  < X onClick={closeCreateAtivityModal} className='size-5'/>
                </button>
              </div>
              <p className='text-sm text-zinc-400'>
                Todos convidados podem vizualizar as atividade
              </p>
          </div>
