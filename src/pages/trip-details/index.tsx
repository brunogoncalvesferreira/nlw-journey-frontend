...
export function TripDetails() {
  const [isCreateAtctivityModalOpen, setIsCreateAtctivityModalOpen] =
    useState(false);

  function openCreateAtivityModal() {
    setIsCreateAtctivityModalOpen(true);
  }

  function closeCreateAtivityModal() {
    setIsCreateAtctivityModalOpen(false);
  }
