    ...
    <div className="max-w-6xl mx-auto w-full px-6 py-10 space-y-8">
      <div className="px-4 h-16 rounded-xl bg-zinc-900 shadow-shape flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-zinc-100">Juiz de Fora MG</span>
        </div>
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-zinc-100">17 a 19 de junho</span>
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <div className="space-y-2.5">
              <div className="px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex items-center gap-3">
                ...
                <span className="text-zinc-100 text-sm">Academia em grupo</span>
